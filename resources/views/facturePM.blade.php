...
<head>
    <title>{{ $json['PM GROUPE FRANCE'][$i]["NOM "]}}</title>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="margin-left:-300px;">
                                <h5 style="font-weight: bold;">{{ $json['PM GROUPE FRANCE'][$i]["NOM "]}}</h5>
                                Mr/Mme : {{ $json['PM GROUPE FRANCE'][$i]["NOM "]}}, {{ $json['PM GROUPE FRANCE'][$i]["PRENOM "]}} <br/>
                                Adresse : {{ $json['PM GROUPE FRANCE'][$i]["ADRESSE "]}} <br/>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6 top-left">
                    <br><br>
                    <h3 class="marginright"><b>FACTURE N° {{ $json['PM GROUPE FRANCE'][$i]["NUMERO FACTURE "]}}</b></h3>
                    <span class="marginright"> Fait le :{{ $json['PM GROUPE FRANCE'][$i]["DATE ENCAISSEMENT "]}}</span>
                </div>
            ...
            <div class="row table-row">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>1,00</td>
                        <td class="text-right">{{ number_format($json['PM GROUPE FRANCE'][$i]["MONTANT "]) }} € </td>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><b style="color: #fff;">INVISIBLE</b></td>
                    <td>Total HT :</td>
                    <td>{{ number_format($json['PM GROUPE FRANCE'][$i]["MONTANT "]) }} €</td>
                </tr>
                <tr>
                    <td>
                        <li class="mb-0 px-2" style="margin-left: 10%;">Payé 100% par virement bancaire
                        le {{ $json['PM GROUPE FRANCE'][$i]["DATE ENCAISSEMENT "]}}</li>
                    </td>
                    <td><b style="color: #fff;">INVISIBLE</b></td>
                    <td>TVA (0%) :</td>
                    <td>0,00 €</td>
                ...
                <tr>
                    <td><b style="color: #fff;">INVISIBLE</b></td>
                    <td><b style="color: #fff;">INVISIBLE</b></td>
                    <td><b>Total TTC : {{ number_format($json['PM GROUPE FRANCE'][$i]["MONTANT "]) }} €</b></td>
                    <td></td>
                </tr>
            </tbody>
        </table>
