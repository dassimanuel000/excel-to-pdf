...
<body style="margin-left: 40px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="width:300px !important;">
                                ...
                                <br>
                                <span class="marginright" style="width:100% !important;border: 2px solid black;padding:5%;">FACTURE N°A{{  (1035 + $i ); }}</span></td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="panel panel-default invoice" id="invoice">
        <div class="panel-body">
            ...
            <span class="marginright" style="padding:1px;">FOURNITURE DE BILAN DE COMPETENCE</span><br>
                </center>
