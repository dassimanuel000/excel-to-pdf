...
<body style="width: 92%;margin-left:3%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="margin-left:-300px;">
                        <h5 style="font-weight: bold;">{{ $json["SCI VERS PM GROUPE"][$i]["NOM"]}}</h5>
                        Mr/Mme : {{ $json["SCI VERS PM GROUPE"][$i]["NOM"]}}, 
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6 top-left">
                    <br><br>
                    <h3 class="marginright"><b>FACTURE N° {{ $json["SCI VERS PM GROUPE"][$i]["NUMERO FACTURE"]}}</b></h3>
                </div>
    ...
    <div class="" style="margin-top: 5%;width:105%;">
        <img src="https://i.ibb.co/Jc9j9zW/rib.png" style="height: auto;width:100%;" alt="" srcset="">
    </div>
